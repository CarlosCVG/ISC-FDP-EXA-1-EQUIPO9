...
public class FDP_EVA1_4_CIRCUITO_ELECTRICO {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Ingresa el valor de la resistencia número 1");
            r1 = teclado.nextDouble();
        System.out.println("Ingresa el valor de la resistencia número 2");    
            r2 = teclado.nextDouble();
        System.out.println("Ingresa el valor de la resistencia número 3");    
            r3 = teclado.nextDouble();
        System.out.println("Ingresa el valor de la resistencia número 4");    
            r4 = teclado.nextDouble();
        System.out.println("Ingresa el valor de la resistencia número 5");    
