...
public class FDP_EVA1_8_HIPERBOLA {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Captura cordenada_x");
        coordenada_x = teclado.nextDouble();
        System.out.println("Captura cordenda_y");
        ...
        System.out.println("Coordenadas del vertice derecho (" + (coordenada_x + verticeDist) + "," + coordenada_y + ")");
        System.out.println("Coordenadas del vertice izquierdo (" + (coordenada_x - verticeDist) + "," + coordenada_y + ")");
